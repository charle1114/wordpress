...
function cosimo_custom_settings_register( $wp_customize ) {
	...
	*/
	...
	'slug'=>'xingurl', 
	'default' => '',
	'label' => __('Xing URL', 'cosimo')
	);
	$socialmedia[] = array(
	'slug'=>'imdburl', 
	'default' => '',
	'label' => __('Imdb URL', 'cosimo')
	);
	$socialmedia[] = array(
	'slug'=>'redditurl', 
	'default' => '',
	'label' => __('Reddit URL', 'cosimo')
	);
	$socialmedia[] = array(
	'slug'=>'twitchurl', 
	'default' => '',
	'label' => __('Twitch URL', 'cosimo')
	);
	...
	*/
	...
	=====================================================
	*/
	$wp_customize->add_setting('cosimo_theme_options_copyrighttext', array(
		'sanitize_callback' => 'cosimo_sanitize_text',
		'default'    => '&copy; '.date('Y').' '. get_bloginfo('name'),
		'type'       => 'theme_mod',
		'capability' => 'edit_theme_options',
	) );
	$wp_customize->add_control('cosimo_theme_options_copyrighttext', array(
		'label'      => __( 'Copyright Text', 'cosimo' ),
		'description' => __( 'Get the PRO version to remove CrestaProject Credits', 'cosimo'),
		'section'    => 'cresta_cosimo_options',
		'settings'   => 'cosimo_theme_options_copyrighttext',
		'type'       => 'text',
	) );
    ...
    class Cosimo_Customize_Upgrade_Control extends WP_Customize_Control {
        public function render_content() {  ?>
			...
			<p style="text-align:center;" class="cosimo-upgrade-button">
				<a style="margin: 10px;" target="_blank" href="https://crestaproject.com/demo/cosimo-pro/" class="button button-secondary">
...
function cosimo_sanitize_text( $input ) {
	return wp_kses($input, cosimo_allowed_html());
}

if( ! function_exists('cosimo_allowed_html')){
	function cosimo_allowed_html() {
		$allowed_tags = array(
			'a' => array(
				'class' => array(),
				'id'    => array(),
